...
const Register = ({setAuth}) => {
  ...
  const {email, password, name, storetype, productlist, storeimg, productimg } = inputs;
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      ...
      const body = {email, password, name, storetype, productlist, storeimg, productimg}
    ...
    return(                
      ...
      ></Box>
        ...
        <input type="file" name="storeimg" placeholder='store-images' 
        className='form-control my-3' value={storeimg} onChange = {e => onChange(e)}
        /> 
        <p>___Upload Logo</p>

        <input type="file" name="productimg" multiple placeholder='product images' 
        className='form-control my-3' value={productimg} onChange = {e => onChange(e)}
        /> 
          <p>___Upload product images</p>
